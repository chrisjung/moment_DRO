...
### DATA PREPARATION ###
########################
def prepare_confounder_data(args, train, return_full_dataset=False, flip_prob=0.0):
    ...
    if full_dataset.flip_labels is not None and flip_prob > 0.0:
        full_dataset.flip_labels(flip_prob)
